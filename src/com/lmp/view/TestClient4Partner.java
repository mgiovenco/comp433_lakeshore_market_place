...
public class TestClient4Partner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Partner partner1 = new Partner("Myco", "6331 N Kenmore Ave", "Chicago", "IL", "60660", "USA", "800-556-8876", "abc@xyz.com", "http://www.xyz.com", "this is a logo", true);
        partnerService.addPartner(partner1);
        System.out.println("listPartners - after new partner add: " + partnerService.listPartners());

        Partner partner2 = new Partner(1, "Myorg", "6332 N Kenmore Ave", "Chicago", "IL", "60660", "USA", "800-666-7776", "abc@abc.com", "http://www.abc.com", "mylogo", true);
